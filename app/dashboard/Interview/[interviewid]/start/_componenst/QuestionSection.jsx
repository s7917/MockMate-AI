...
function QuestionSection({activeQuestionIndex , mockInterviewQuestion }) {
  ...
  return mockInterviewQuestion &&(
    <div className='p-5 border rounded-lg my-10'>
        ...
        <h2 className={`p-2 bg-secondary rounded-lg text-xs md:text-sm text-center cursor-pointer ${activeQuestionIndex ==index && 'bg-red-600  text-white'}`}>question #{index +1}</h2>
